...
export const ExtendScriptSnippets = {
  ...
  `,
     ...
     * Create a text layer
     */
    createTextLayer: (text, x = 100, y = 100, fontSize = 24, fontName) => `
    ${getContextInfo}
  ...
  `,
     ...
     */
    applyGradientMask: (direction = 'bottom_to_top', startPct = 0, endPct = 100, angleDeg) => {
  ...
  `,
    ...
    generativeRemove: (featherPx, autoSelectSubject) => `
    ${helperFunctions}
    ${ExtendScriptSnippets.generativeHelpers()}
  ...
  `,
    generativeExpand: (direction, prompt) => {
        const escaped = jsString(prompt);
  ...
  `;
     ...
     */
    adjustVibrance: (vibrance, saturation) => `
    ${helperFunctions}
  ...
  `,
     ...
     */
    adjustExposure: (exposure, offset, gamma) => `
    ${helperFunctions}
  ...
  `,
     ...
     */
    applyPhotoFilter: (red, green, blue, density, preserveLuminosity) => `
    ${helperFunctions}
  ...
  `;
     ...
     */
    applyDataSetsExport: (outputDir, format, datasetNames) => {
  ...
  `;
     ...
     */
    exportAs: (filePath, format, quality) => {
